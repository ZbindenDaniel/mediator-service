      ...
      <div class="card">
        ...
        <input name="Location" value="${esc(d.Location) || ""}" hidden/>
          ...
          <div class="row">
            ...
            <input name="Auf_Lager" type="number" value="${Number.isFinite(d.Auf_Lager) ? d.Auf_Lager : (parseInt(d.Auf_Lager || "0", 10) || 0)}" />
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <input name="Länge_mm" type="number" value="${Number.isFinite(d.Länge_mm) ? d.Länge_mm : (parseInt(d.Länge_mm || "0", 10) || 0)}" />
          </div>
          <div class="row">
            <label>Breite (mm)</label>
            <input name="Breite_mm" type="number" value="${Number.isFinite(d.Breite_mm) ? d.Breite_mm : (parseInt(d.Breite_mm || "0", 10) || 0)}" />
          </div>
          <div class="row">
            <label>Höhe (mm)</label>
            <input name="Höhe_mm" type="number" value="${Number.isFinite(d.Höhe_mm) ? d.Höhe_mm : (parseInt(d.Höhe_mm || "0", 10) || 0)}" />
          </div>
          <div class="row">
            <label>Gewicht (kg)</label>
            <input name="Gewicht_kg" type="number" step="0.01" value="${Number.isFinite(d.Gewicht_kg) ? d.Gewicht_kg : (parseFloat(d.Gewicht_kg || "0") || 0)}" />
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <input name="Shopartikel" type="number" min="0" max="1" value="${Number.isFinite(d.Shopartikel) ? d.Shopartikel : (parseInt(d.Shopartikel || "0", 10) || 0)}" />
          </div>
          <div class="row">

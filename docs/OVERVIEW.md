...
## Recent Highlights
- Reconnected the label printing flow to the HTML templates so `PrintLabelButton` opens the routed pages again, with actor-aware payloads delivered via the existing helper.

...
## Recent Highlights
- Replaced the standalone HTML print templates with a routed `PrintLabel` React component that fetches payloads directly and renders printable previews for boxes and items.

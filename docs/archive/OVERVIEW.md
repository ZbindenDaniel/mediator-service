...
33. ✅ Introduce versioned highlights process: split `docs/RECENT_HIGHLIGHTS.md` into v2.3 historical notes and a v2.3 upcoming section so release history stays auditable between versions.

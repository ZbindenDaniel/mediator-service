...
## Core concepts
- Agentic run lifecycle from extraction to review completion.
- Prompt contracts, JSON validation, and correction fallbacks.
- Supervisor orchestration and bounded iteration controls.
- Human-in-the-loop checkpoints and persistence of review decisions.

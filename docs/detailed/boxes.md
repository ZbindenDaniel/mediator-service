...
## Core concepts
- Box identity and shelf addressing constraints.
- Box occupancy, capacity, and item assignment invariants.
- Box creation/import/update flows across backend and UI.
- Distinction between physical storage metadata and operational status.
...
- `models/box*`
- `backend/src/models/box*`
- `backend/actions/*box*`
- `backend/importer.ts`
- `frontend/src/components/*Box*`

...
## Core concepts
- QR payload schema for item and box resolution.
- Encoding/rendering path from backend payload to printable asset.
- Scan-to-route navigation and lookup behavior in frontend.
- Validation rules preventing malformed or stale QR references.
...
- `frontend/src/routes/*scan*`
- `frontend/src/utils/*qr*`

...
## Core concepts
- End-to-end path from item ingestion to shelf/box assignment.
- Transition checkpoints between import, enrichment, review, and publish states.
- Event and action boundaries for mutation versus read-only views.
- Observable handoffs between backend actions and frontend workflows.

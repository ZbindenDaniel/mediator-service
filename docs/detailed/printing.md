...
## Core concepts
- Label payload composition for item and box print jobs.
- Printer selection/routing and runtime command orchestration.
- Retry and transient failure handling around print pipelines.
- Contract between UI-triggered print actions and backend execution.
...
- `backend/actions/*print*`
- `backend/src/lib/*print*`
- `backend/src/lib/*lpstat*`
- `frontend/src/components/*Print*`
- `frontend/src/routes/*print*`

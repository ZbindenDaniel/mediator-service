...
## 959. ✅ Spec contract for 109 (All-in-One)
...
**Deferred:** Successful prints (only `PrintFailed` logs today), ERP sync, stub close, and a distinct reference-created event are still unlogged — noted in todo.md #25. No backfill of history for items/boxes created before this fix.

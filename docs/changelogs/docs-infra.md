...
## 955. ✅ Rework-feature concept doc (`PLANNING_rework_feature.md`)
...
**Deferred:** Everything actionable — no lever is scheduled or built. Auto-approve integration noted as common ground but explicitly out of scope.

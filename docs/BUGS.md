...
- [x] Behälter is often times 'nicht gesetzt' although the item is in a Box. Make sure it displays the box id
...
- [x] this list should show the last 5 events. not more. (this also goes for ite detail)

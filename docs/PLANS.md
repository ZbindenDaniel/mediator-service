...
This file is the single entry point for all active feature planning documents.

## Active Planning Documents

- [`docs/PLANNING_V_2_3.md`](PLANNING_V_2_3.md) — v2.3 sprint priorities, phase breakdown, and planning intake
...
- [`docs/PLANNING_TENANCY.md`](PLANNING_TENANCY.md) — Phased plan for multi-tenancy (identity-first): shared catalogue / private logistics, Authentik forward-auth, class-aware scoping

## Active task tracker

- Open bugs and feature queue: [`todo.md`](../todo.md)
- Completed task log: [`OVERVIEW.md`](../OVERVIEW.md)

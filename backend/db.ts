...
SELECT
  ...
  CAST(NULLIF(r."Hauptkategorien_A",'')::numeric AS INTEGER) AS "Hauptkategorien_A",
  CAST(NULLIF(r."Unterkategorien_A",'')::numeric AS INTEGER) AS "Unterkategorien_A",
  CAST(NULLIF(r."Hauptkategorien_B",'')::numeric AS INTEGER) AS "Hauptkategorien_B",
  CAST(NULLIF(r."Unterkategorien_B",'')::numeric AS INTEGER) AS "Unterkategorien_B",
  ...
  try {
    return query<AgenticRunReviewHistoryEntry>(
      `SELECT h."Id",h."Artikel_Nummer",h."Status",h."ReviewState",h."ReviewDecision",h."ReviewNotes",h."ReviewMetadata",h."ReviewedBy",h."RecordedAt"
       ...
       WHERE CAST(NULLIF(r."Unterkategorien_A",'')::numeric AS INTEGER)=$1

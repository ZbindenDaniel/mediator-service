...
export function sanitizeJsonInput(rawInput, { loggerInstance = defaultLogger, context } = {}) {
  ...
  if (actions.length && loggerInstance && typeof loggerInstance.debug === 'function') {
...
export function parseJsonWithSanitizer(rawInput, options) {

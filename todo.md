...
0z4. **AI runs optimization — phased implementation** (design: `docs/PLANNING_ai_runs_optimization.md`).
  ...
  - **Next — Phase 4 (Thread 4, snapshots):** `agentic_run_snapshots` table (pre-run/pre-rework, keep 5), **manual** restore button in the KI tab, and a run-to-run before→after diff view next to the search-sources panel.

...
50. **Rework mechanism.** — Coherence/feature-shape concept (entry-point inventory, "shadow process" diagnosis, unified model, lever menu L1–L5) captured in [`docs/PLANNING_rework_feature.md`](docs/PLANNING_rework_feature.md). Nothing scheduled from it yet.

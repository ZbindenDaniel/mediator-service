...
50. **Rework mechanism.** — Now folded into the unified **AI Data Quality Lifecycle** plan [`docs/PLANNING_ai_data_quality.md`](docs/PLANNING_ai_data_quality.md) (Pillar D = rework as the single execution arm; levers L1–L5). That plan also absorbs the instance-flow/reconciliation plan and the contract-"smell" fix (Phase 0). Nothing scheduled yet. (Concept ancestors: `PLANNING_rework_feature.md`, `PLANNING_instance_flow.md` — both superseded.)
